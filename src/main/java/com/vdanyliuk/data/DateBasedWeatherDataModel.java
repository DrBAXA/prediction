...
public class DateBasedWeatherDataModel implements IndependentDataModel<WeatherModel>, DependentDataModel, Serializable {
    ...
    public void store(File storedData) throws IOException {
        try (OutputStream stream = new FileOutputStream(storedData);
    ...
    public void addData(LocalDate date, WeatherModel model, Double load) {
        weatherData.put(date, model);
        loadData.put(date, load);
    }
    ...
    public MatrixBuilder getDataBuilder(WeatherModel model) {
        return new MatrixBuilder()
                ...
                .addParameter(getIntegralParam(model, "avgTemperature", 6) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "avgTemperature", 6) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "avgTemperature", 6) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "avgTemperature", 6) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "avgTemperature", 6) * Holidays.school(model.getDate()), d -> -d)
                ...
                .addParameter(getIntegralParam(model, "clouds", 3) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "clouds", 3) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "clouds", 3) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "clouds", 3) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "clouds", 3) * Holidays.school(model.getDate()), d -> -d)
                ...
                .addParameter(getIntegralParam(model, "wind", 4) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "wind", 4) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "wind", 4) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "wind", 4) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "wind", 4) * Holidays.school(model.getDate()), d -> -d)
                ...
                .addParameter(getIntegralParam(model, "precipitation", 4) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "precipitation", 4) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "precipitation", 4) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "precipitation", 4) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "precipitation", 4) * Holidays.school(model.getDate()), d -> -d)
                ...
                .addParameter(getIntegralParam(model, "avgHumidity", 3) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "avgHumidity", 3) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "avgHumidity", 3) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "avgHumidity", 3) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "avgHumidity", 3) * Holidays.school(model.getDate()), d -> -d)
                ...
                .addParameter(getIntegralParam(model, "visibility", 3) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "visibility", 3) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "visibility", 3) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "visibility", 3) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "visibility", 3) * Holidays.school(model.getDate()), d -> -d)
                ...
                .addParameter(getIntegralParam(model, "dewPoint", 4) * Holidays.state(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "dewPoint", 4) * Holidays.state(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "dewPoint", 4) * Holidays.religious(model.getDate()), d -> -d)
                .addParameter(getIntegralParam(model, "dewPoint", 4) * Holidays.religious(model.getDate()), cubic)
                .addParameter(getIntegralParam(model, "dewPoint", 4) * Holidays.school(model.getDate()), d -> -d)
    ...
    private Map<LocalDate, Double> getLoad() throws IOException {
